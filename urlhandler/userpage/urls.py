...
urlpatterns = patterns('',
                       ...
                       url(r'^vote/submit/$','userpage.views.vote_submit'),
                       url(r'^vote/info/(?P<voteActId>\d+)/$','userpage.views.vote_activity_info'),
                       url(r'^vote/(?P<voteActId>\d+)/(?P<openid>\S+)/$','userpage.views.vote_details_view'),
