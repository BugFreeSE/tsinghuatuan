...
urlpatterns = patterns('',
                       ...
                       url(r'^list/$', 'adminpage.views.vote_list'),
                       url(r'^detail/(?P<act_id>\d+)/$', 'adminpage.views.vote_detail'),
                       url(r'^add/$', 'adminpage.views.vote_add'),
                       url(r'^edit/(?P<voteid>\d+)/$', 'adminpage.views.vote_edit'),
                       url(r'^uploadImg/(?P<act_id>\d+)/$', 'adminpage.views.vote_act_upload_img'),
                       url(r'^begin/(?P<act_id>\d+)/$', 'adminpage.views.vote_begin'),
                       url(r'^end/(?P<act_id>\d+)/$', 'adminpage.views.vote_end'),
                       url(r'^pub/(?P<act_id>\d+)/$', 'adminpage.views.vote_pub'),
                       url(r'^detail_download/(?P<act_id>\d+)/$', 'adminpage.views.vote_download_excel'),
                       url(r'^index/', 'adminpage.views.vote_index'),
                       url(r'^set_result/(?P<act_id>\d+)/$', 'adminpage.views.vote_set_result'),
