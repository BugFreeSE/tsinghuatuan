...
urlpatterns = patterns('',
                       ...
                       url(r'^vote/detail/(?P<act_id>\d+)/$$', 'adminpage.views.vote_detail'),
                       ...
                       url(r'^vote/begin/(?P<act_id>\d+)/$', 'adminpage.views.vote_begin'),
                       url(r'^vote/end/(?P<act_id>\d+)/$', 'adminpage.views.vote_end'),
                       url(r'^vote/pub/(?P<act_id>\d+)/$', 'adminpage.views.vote_pub'),
                       url(r'^vote/detail/download/(?P<act_id>\d+)/$', 'adminpage.views.vote_download_excel'),
                       )